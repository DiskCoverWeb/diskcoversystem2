...
$(document).ready(function () {
 ...
 function buscar_numero_ci() {
   ...
   $.ajax({
     url: '../php/controlador/modalesC.php?buscar_cliente=true',
     type: 'post',
     dataType: 'json',
     data: { search: ci_ruc },
     beforeSend: function () {
 ...
 function provincias() {
   ...
   $.ajax({
     url: '../php/controlador/educativo/detalle_estudianteC.php?provincias=true',
     type: 'post',
     dataType: 'json',
 ...
 function codigo() {
   ...
   if (ci != '') {
     $.ajax({
       url: '../php/controlador/modalesC.php?codigo=true',
       type: 'post',
       dataType: 'json',
       data: { ci: ci },
       beforeSend: function () {
 ...
 function buscar_cliente_nom() {
   ...
   $.ajax({
     ...
     url: '../php/controlador/modalesC.php?buscar_cliente_nom=true',
     type: 'post',
     dataType: 'json',
     success: function (response) {
       // console.log(response);
 ...
 function guardar_cliente() {
   ...
   $.ajax({
     ...
     url: '../php/controlador/modalesC.php?guardar_cliente=true',
     type: 'post',
     dataType: 'json',
     success: function (response) {
       $('#myModal_espera').modal('hide');
       ...
       if (result.value) {
         ...
         if ($.isNumeric(CMedidorNew)) {
           $.ajax({
             type: 'POST',
             dataType: 'json',
             url: '../php/controlador/modalesC.php?AddMedidor=true',
     ...
     Swal.fire({
       ...
       if (result.value == true) {
         $.ajax({
           type: 'POST',
           dataType: 'json',
           url: '../php/controlador/modalesC.php?DeleteMedidor=true',
 ...
 function ListarMedidores(codigo) {
   if (codigo != "" && codigo != ".") {
     $.ajax({
       url: '../php/controlador/modalesC.php?ListarMedidores=true',
       type: 'POST',
       dataType: 'json',
       data: { 'codigo': codigo },
       success: function (response) {
 ...
 function tipo_proveedor_Cliente() {
   $.ajax({
     url: '../php/controlador/modalesC.php?tipo_proveedor=true&TP=TIPOPROV',
     type: 'post',
     dataType: 'json',
     success: function (response) {
 ...
 function DLCxCxP() {
   $('#DLCxCxP').select2({
     ...
     ajax: {
       url: '../php/controlador/modalesC.php?DLCxCxP=true&SubCta=' + $('#SubCta').val(),
       dataType: 'json',
       delay: 250,
 ...
 function DLGasto() {
   $('#DLGasto').select2({
     ...
     width: '100%',
     ajax: {
       url: '../php/controlador/modalesC.php?DLGasto=true&SubCta=' + $('#SubCta').val(),
       dataType: 'json',
       delay: 250,
       processResults: function (data) {
         console.log(data);
 ...
 function DLSubModulo() {
   $('#DLSubModulo').select2({
     ...
     width: '100%',
     ajax: {
       url: '../php/controlador/modalesC.php?DLSubModulo=true&SubCta=' + $('#SubCta').val(),
       dataType: 'json',
       delay: 250,
       processResults: function (data) {
         console.log(data);
 ...
 function guardar_cuentas() {
   ...
   $.ajax({
     url: '../php/controlador/farmacia/proveedor_bodegaC.php?guardar_cuentas=true',
     type: 'post',
     dataType: 'json',
     data: datos,
     success: function (response) {
 ...
 function ListarCuenta(nombre){
   ...
   $.ajax({
     data: { parametros: parametros },
     url: '../php/controlador/modalesC.php?ListarCuenta=true',
     type: 'post',
     dataType: 'json',
     success: function (response) {
       console.log(response);
