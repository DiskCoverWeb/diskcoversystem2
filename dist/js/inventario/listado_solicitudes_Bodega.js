...
$(document).ready(function () {
    ...
    tbl_pedidos_all = $('#tbl_listado').DataTable({
          ...
          ajax: {
              url:   '../controlador/inventario/solicitud_material_bodegaC.php?pedidos_contratista=true',
          ...
          columns: [
              ...
              { data: null,
                 render: function(data, type, item) {
                    return `<a href="../vista/inicio.php?mod=03&acc=DetalleSolicitudesBodega&orden=${data.Orden_No}">${data.Cliente}'</a>`;                    
                  }
              },              
              { data: 'Orden_No' },
              { data: 'Fecha.date',  
              ...
              { data: null,
                 render: function(data, type, item) {
                  if(data.TC=='.')
                  {
                     ...
                     return `<div class="badge rounded-pill bg-primary text-white w-100">Para Genera comprobante</div>`;                    
