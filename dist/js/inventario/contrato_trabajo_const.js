  ...
  $(document).ready(function () {
      ...
      tbl_pedidos_all = $('#tbl_lista_solicitud').DataTable({
          ...
          ajax: {
              url:   '../controlador/inventario/contrato_trabajo_constC.php?cargar_lista_contratos=true',
...
function eliminar_contrato(id)
{
  $.ajax({
    data:  {id:id},
    url:   '../controlador/inventario/contrato_trabajo_constC.php?eliminar_contrato=true',
    type:  'post',
    dataType: 'json',
    success:  function (response) { 
      if(response)
