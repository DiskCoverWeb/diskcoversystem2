  $(document).ready(function () {
      ...
      tbl_pedidos_all = $('#tbl_lista_solicitud').DataTable({
          ...
          ajax: {
              url:   '../controlador/inventario/orden_trabajo_constC.php?aprob_cargar_lista=true',
          ...
          columns: [
              ...
              { data: null,
                 render: function(data, type, item) {
                    ...
                    return `<a href="inicio.php?mod=03&acc=detalle_orden_trabajo_const&ordenNo=${data.Detalle}">${data.Detalle}</a>`;                    
                  }
              },
              { data: 'Fecha_D.date',  
                  render: function(data, type, item) {
