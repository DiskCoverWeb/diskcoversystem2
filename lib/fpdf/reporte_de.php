...
function imprimirGuiaRemision($DtaFactura, $DtaDetalle, $TFA){
	$conn = new db();
	$CadenaMoneda = "";
	$Numero_Letras = "";
	$CxC_Clientes = "";
	...
	if(count($DtaFactura) > 0){
		...
		if(count($DtaDetalle) > 0){
			$CxC_Clientes = $DtaDetalle[0]["Concepto"];
			$Cta_Cobrar = $DtaDetalle[0]["CxC"];
			$Cta_Ventas = $DtaDetalle[0]["Cta_Venta"];
			$TFA['LogoFactura'] = $DtaDetalle[0]["Logo_Factura"];
			$TFA['AltoFactura'] = $DtaDetalle[0]["Largo"];
			$TFA['AnchoFactura'] = $DtaDetalle[0]["Ancho"];
			$TFA['EspacioFactura'] = $DtaDetalle[0]["Espacios"];
			$TFA['Pos_Factura'] = $DtaDetalle[0]["Pos_Factura"];
			$CodigoL = $DtaDetalle[0]["Codigo"];
			$CantFact = $DtaDetalle[0]["Fact_Pag"];
		}
  ...
  '''              PrinterPaint LogoTipo, SetD(34).PosX, SetD(34).PosY, 2.5, 1.25
		...
		$DireccionCli = $DtaFactura[0]["Direccion"];
		$DireccionGuia = $DtaFactura[0]["Comercial"];
