          ...
          AND Serie = '" . $FA['Serie'] . "' ";
			...
			if (strlen($FA['Autorizacion']) >= 13) {
				...
				if ($FA['TC'] <> "DO") {
					...
					}else if($rep=='' || $rep==null)
					{
						$respuesta_facturacion['Factura'] = array(-5,'Enviada pero no validado,sin conexion a SRI');
					}
					...
					if ($rep[0] == 1) {
						...
						// } else 
						if ($_SESSION['INGRESO']['Impresora_Rodillo'] == 0 && $_SESSION['INGRESO']['Grafico_PV'] == 1) {
