  ...
  <div class="col-sm-6">
     <div class="btn-group" role="group" aria-label="Basic example">
        ...
        <!-- <button title="Guardar"  class="btn btn-outline-secondary" onclick="grabar_solicitud_proveedor()">
         ...
         <a title="Nuevo"  class="btn btn-outline-secondary" href="../vista/inicio.php?mod=<?php echo $_GET['mod']; ?>&acc=orden_trabajo_const">
       ...
       <div class="row">
         <div class="col-sm-12">
              <div class="table-responsive">
                <table class="table w-100" id="tbl_lista_solicitud_ord">
                  <thead>
                     <th>No</th>
                     <th>Contratista</th>
