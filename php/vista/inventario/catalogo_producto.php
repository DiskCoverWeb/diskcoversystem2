...
<div class="row mb-2">
  <div class="col-sm-6">
     <div class="btn-group">
		...
		<button type="button" class="btn btn-outline-secondary"  data-bs-toggle="tooltip" title="Grabar" onclick="guardarINV()">  <img src="../../img/png/grabar.png"></button>
		<button type="button" class="btn btn-outline-secondary"  data-bs-toggle="tooltip" title="Imprimir Grupo" onclick="codigo_barras_grupo();"><img src="../../img/png/impresora.png"></button>
		<button type="button" class="btn btn-outline-secondary"  data-bs-toggle="tooltip" title="Imprimir" onclick="cantidad_codigo_barras();//codigo_barras()">  <img src="../../img/png/barcode.png"></button>
...
<div class="row">
	<div class="col-lg-6 col-12">
		<div class="card border" style="height: 63vh;">
			...
			<div class="card-body">
				<form id="form_datos" name="form_datos">
					...
					<div class="row mt-2">
						...
						<div class="col-xxl-6 mt-xxl-0 col-12 mt-1">
							<div class="input-group input-group-sm">
						...
						<div class="col-xxl-6 col-12 mt-1">
							<div class="input-group input-group-sm">
						...
						<div class="col-xxl-8 col-12 mt-1">
							<div class="input-group input-group-sm">
						...
						<div class="col-xxl-4 col-sm-12 col-lg-4 mt-1">
							<div class="input-group input-group-sm">
						...
						<div class="col-xxl-6 col-sm-12 col-lg-8 mt-1">
							<div class="input-group input-group-sm">
						...
						<div class="col-xxl-6 col-sm-12 col-lg-12 mt-1">
							<div class="input-group input-group-sm">
