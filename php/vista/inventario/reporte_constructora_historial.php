<!--
 ...
 -->
<script src="../../dist/js/inventario/reporte_constructora_historial.js"></script>
			...
			<div class="row">
				<div class="col-sm-4">
					...
					<div class="d-flex align-items-center">
						...
						<span class="input-group-btn">
							<button class="btn btn-danger btn-sm" onclick="limpiar_contra()"><i class="bx bx-x me-0"></i></button>
						</span>
					</div>
				</div>
				<div class="col-sm-3">
					<b>Orden</b>
					<div class="d-flex align-items-center">
						<select class="form-control form-control-sm" id="ddl_orden" onchange="cargar_datos()">
							<option value="">Selecciones</option>
						</select>			
				...
				<div class="col-sm-2">
					...
					<div class="input-group input-group-sm">
						<select class="form-control form-control-sm" id="ddl_meses" onchange="Calcularsemanas();">
							<option value="">Selecciones</option>
						</select>
				...
				<div class="col-sm-2">
					<b>Semana</b>
					<div class="input-group input-group-sm">
						<select class="form-control form-control-sm" id="ddl_semanas">
							<option value="">Selecciones</option>
						</select>
