...
<!-- BOTONES CXC y CXP -->
<div class="row">
  <div class="row col-lg-7 col-sm-10 col-md-6 col-xs-12 ps-4" style="padding-bottom: 5px;">
    <div class="col-2 col-md-2 col-sm-2 col-lg-1" style="padding: 0px">
      <a href="./farmacia.php?mod=Farmacia#" data-toggle="tooltip" title="Salir de modulo" class="btn btn-default"
        style="border: solid 2px;">
        <img src="../../img/png/salire.png">
      </a>
    </div>
    <div class="col-2 col-md-2 col-sm-2 col-lg-1" style="padding-left: 15px;">
    ...
    <div class="col-2 col-md-2 col-sm-2 col-lg-1" style="padding-left: 30px ;">
...
<div class="box box-info p-2 border">
