      ...
      <div class="modal-body">
       	<div class="row">
	                ...
	                <div class="input-group">
	                  <div class="form-control-sm col-md-12 btn_f text-center" >
	                    <b>CONCEPTO DEL COMPROBANTE:</b>
	                  </div>
	                  <textarea class="form-control form-control-sm" id="TxtConceptoChangeValores" name="TxtConceptoChangeValores" onblur="TextoValido(this)"></textarea>
	                ...
	                <div class="input-group">
	                  <div class="col-md-12 btn_f text-center" >
	                    <b>Cheq./Dep.No.</b>
	                  </div>
	                  <input class="form-control form-control-sm" id="TxtDepositoChangeValores" name="TxtDepositoChangeValores"/>
	                </div>
								</div>
								<div class="col-md-4 text-center">
	                <div class="input-group">
	                  ...
	                  <input class="form-control form-control-sm" id="TxtDebeChangeValores" name="TxtDebeChangeValores" onblur="TextoValido(this, true, false, 2)"/>
	                </div>
								</div>
								<div class="col-md-4 text-center">
	                <div class="input-group">
	                  ...
	                  <input class="form-control form-control-sm" id="TxtHaberChangeValores" name="TxtHaberChangeValores" onblur="TextoValido(this, true, false, 2)"/>
	                </div>
								</div>
							</div>
							<div class="row">
	                ...
	                <div class="input-group">
	                  ...
	                  <input class="form-control form-control-sm" id="TxtDetalleChangeValores" name="TxtDetalleChangeValores"/>
	                </div>
								</div>
					...
					<div class="col-md-2 text-center">
						<div class="row">
							<div class="col-md-12 col-sm-6">                
								<button type="button" class="btn btn-outline-secondary" onclick="Cambiar_Valores_Modal()">
