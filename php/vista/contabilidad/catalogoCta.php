  ...
  <div class="row mb-2">
    <div class="col-lg-5 col-md-6 col-sm-12">
      <div class="btn-group" role="group" aria-label="Basic example">
	      	<a href="inicio.php?mod=<?php echo $_SESSION['INGRESO']['modulo_']; ?>" data-toggle="tooltip" title="Salir de modulo" class="btn btn-sm btn-outline-secondary">
					<img src="../../img/png/salire.png">
				</a>
				<a href="#" class="btn btn-sm btn-outline-secondary" id='imprimir_pdf'  data-toggle="tooltip"title="Descargar PDF">
					<img src="../../img/png/pdf.png">
				</a>
				<a href="#"  class="btn btn-sm btn-outline-secondary"  data-toggle="tooltip"title="Descargar excel" id='imprimir_excel'>
					<img src="../../img/png/table_excel.png">
				</a>
				<button title="Consultar Catalogo de cuentas"  data-toggle="tooltip" class="btn btn-sm btn-outline-secondary" onclick="consultar_datos();">
					<img src="../../img/png/consultar.png" >
				</button>  	      
      </div>
    </div>
    <div class="col-12 col-sm-12 col-ms-6 col-lg-2">
			<b>Cuenta inicial:</b>
