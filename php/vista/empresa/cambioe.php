		...
		<div class="card">
			<div class="card-body">
				<form id="form_empresa">
					<div class="row" id="datos_empresa"></div>
					<div class="row">
						<div class="col-sm-12">
							<div class="nav-tabs-custom">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="tab_1">
										...
										<div class="row">
											<div class="col-sm-12" style="font-size:16pt;font-weight:800;padding-left:0">
												<b style="background-color: #c6dcf9; margin: 0 5px 0 5px;padding: 5px;border: 1px solid #999999;border-radius: 5px 5px 0 0;">Comprobantes Electrónicos</b>
											</div>
											<div class="col-sm-12"  style="background-color:#c6dcf9;margin: 0 5px 5px 5px;padding:10px;border: 1px solid #999999;border-radius: 5px;">
												<div class="row">													
													<div class="col-sm-3">
														<b>WEBSERVICE SRI RECEPCION</b>
													</div>
													<div class="col-sm-2">   
														<label>
															<input class="form-check-input" type="radio" name="optionsRadios" id="optionsRadios1" value="option1" onclick="AmbientePrueba()">
															Ambiente de Prueba
														</label>
													</div>
													<div class="col-sm-3">
														<label>
															<input class="form-check-input" type="radio" name="optionsRadios" id="optionsRadios2" value="option2" onclick="AmbienteProduccion()">
												...
												<div class="row">
													<div class="col-sm-10">
														<label>
															<input type="checkbox" id="rbl_copia" name="rbl_copia">
															Enviar Copia de Email
														</label>(;)
